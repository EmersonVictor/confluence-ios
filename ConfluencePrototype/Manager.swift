...
class Manager: NSObject{
    ...
    private override init(){
        ...
        let eventFour: EventUnit = EventUnit(eventTitle: "Aula de Capoeira", eventCreator: "2", id: "4", locationName: "Marco Zero", motivation: "Aula de capoeira para todos os públicos (iniciante à avançado)", coordinate: CLLocationCoordinate2D(latitude: -8.063153, longitude: -34.871117), imageTitle: "profile-picture.png")
        let eventFive: EventUnit = EventUnit(eventTitle: "Atividades recreativas", eventCreator: "2", id: "5", locationName: "Lar Batista Elizabeth Mein", motivation: "Relização de atividades recreativas para as crianças do orfanato", coordinate: CLLocationCoordinate2D(latitude: -8.043808, longitude: -34.927336), imageTitle: "engage.png")
        let eventSix: EventUnit = EventUnit(eventTitle: "Adoção de animais", eventCreator: "2", id: "6", locationName: "ONG PetPE", motivation: "Adote um doge ou um gatíneo", coordinate: CLLocationCoordinate2D(latitude: -8.159588, longitude: -34.911214), imageTitle: "tutorial-bg-1.jpg")
