...
class Manager: NSObject{
    ...
    private override init(){
        ...
        let eventSix: EventUnit = EventUnit(eventTitle: "Adoção de animais", eventCreator: "2", id: "6", locationName: "ONG PetPE", motivation: "Os animaizinhos esão tristes e precisam de um dono", date: "10-28-1995 20:00", coordinate: CLLocationCoordinate2D(latitude: -8.159588, longitude: -34.911214), image: UIImage(named: "tutorial-bg-1.jpg")!)
